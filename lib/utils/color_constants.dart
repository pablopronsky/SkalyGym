...
class AppColors {
  ...
  static const backgroundColorLightMode = Color.fromRGBO(255, 255, 255, 1.0);
  // <------------------------ TextField ------------------------>
  static const textFieldColorDarkMode = Color.fromRGBO(27, 32, 40, 0.8);
  static const textFieldColorLightMode = Color.fromRGBO(27, 32, 40, 1.0);
  // <------------------------ AccentColor ------------------------>
